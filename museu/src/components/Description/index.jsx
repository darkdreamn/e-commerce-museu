    ...
    return (
        <article className='article-bg-color'>
            <div className='article-container'>
                ...
                <p>
                    A palestra em movimento nas dependências da musArt, propõem uma imersão analítica nas obras de Michelangelo Merisi (ou Amerighi), conhecido como Caravaggio. Um dos mais notados pintores italianos, atuante em Roma, Nápoles, Malta e Sicília, entre 1593 e 1610. Documentos encontrados recentemente atestam a presença de Caravaggio pela primeira vez em Roma por volta de 1596: no depoimento de um barbeiro, preso porque se manteve reticente sobre o nome da pessoa que lhe havia entregado um manto encontrado durante uma rixa, surgiu o nome de Caravaggio, com sua exata descrição física e, principalmente, com a informação de que trabalhava com o pintor siciliano Lorenzo Carli (?-1597).</p>
                <p>
